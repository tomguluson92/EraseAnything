...
def inject_adapter_in_model(
    ...
    # import pdb; pdb.set_trace()
    # (Pdb) parameters['transformer_blocks.0.attn.add_k_proj.lora_A.default_0.weight']
    # Parameter containing:
    # tensor(..., device='meta', size=(8, 3072), requires_grad=True)
    # (Pdb) type(parameters['transformer_blocks.0.attn.add_k_proj.lora_A.default_0.weight'])
