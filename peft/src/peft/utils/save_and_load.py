...
def set_peft_model_state_dict(
    ...
    # 2024.11.29
    # Q: how to calculate when input given
    # (Pdb) config.peft_type <PeftType.LORA: 'LORA'>
    # import pdb; pdb.set_trace()
    # len(peft_model_state_dict.keys())
    ...
    if low_cpu_mem_usage:
        ...
        load_result = model.load_state_dict(peft_model_state_dict, strict=False)
    # (Pdb) len(load_result[0]) 1160
    # (pdb) load_result[1] unexpected_keys=[]
    # import pdb; pdb.set_trace()
